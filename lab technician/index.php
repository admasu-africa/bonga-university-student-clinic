...
<body>
    ...
    <div class="home">
      ...
      <div class="row content"> 
        <!--  -->
      <div class="col col-12 col-md-12 col-lg-4" onclick="location.href='order.php'" style="border-left: 4px solid red; box-shadow: 0 0 1px 1px skyblue; margin: 5px;">     
        <div class="inside_text_1">
          View Order Given From Doctor
        </div>
        <div class="inside_text_1">
          Total: 
        </div>
      ...
      <div class="col col-12 col-md-12 col-lg-4" onclick="location.href='view_news.php'" style="border-left: 4px solid red; box-shadow: 0 0 1px 1px skyblue; margin: 5px;">     
        <div class="inside_text_1">
          View News
        </div>
      </div> 
