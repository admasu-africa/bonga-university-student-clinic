...
<html>
<head>
	<title>Pharmacist | Store Drug Info</title>
	...
	<?php include 'include/side_bar.php'; ?>
     ...
     <?php include 'include/navbar.php'; ?>
      ...
      <div class="text">
        ...
        <span class="right_second_header"><i class="fas fa-"></i> Store drug info</span>
      </div>
      ...
      <div class="row content" style="cursor: auto;"> 
		...
		<?php
		$today = date("Y-m-d");
		$sql = "SELECT ds.drug_name, ds.quantity, ds.measure, ds.expire_date,ds.drug_id from drug_store as ds where ds.expire_date > '$today' AND ds.quantity > 0 order by quantity asc";
