...
<html>
<head>
	<title>StoreKeeper | Dispensary Drug Info</title>
...
<?php include 'include/side_bar.php'; ?>
     ...
     <?php include 'include/navbar.php'; ?>
      ...
      <div class="row content" style="cursor: auto;"> 
		...
		<?php
		$today = date("Y-m-d");
		$sql = "SELECT ds.drug_name, ph.quantity, ph.measure, ds.expire_date,ph.drug_id from pharmacy as ph INNER JOIN drug_store as ds ON ph.drug_id = ds.drug_id AND ds.expire_date > '$today'";
