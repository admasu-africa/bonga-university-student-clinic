      ...
      <div class="row content"> 
		...
		<?php 
		 ...
		 <?php
		  ...
		  //$sql = "SELECT ps.drug_name, ps.dose, ps.description FROM prescription as ps INNER JOIN patient_info as pai on (pai.patient_info_id = ps.patient_info_id AND pai.patient_info_id = ps.patient_info_id) inner join drug_store as ds on ps.drug_name = ds.drug_name where pai.status = 4 ";
