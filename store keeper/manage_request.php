...
<html>
<head>
	<title>StoreKeeper | Manage Request</title>
	...
	<?php include 'include/side_bar.php'; ?>
     ...
     <?php include 'include/navbar.php'; ?>
      ...
      <div class="text">
        ...
        <span class="right_second_header"><i class="fas fa-"></i>Manage Request</span>
      </div>
      ...
      <div class="row content"> 
        <!--  -->
	      <div class="col col-12 col-md-12">     
	         <div>
		<select id="select_request" class="form-select mb-3 mt-3" style="border-radius: 26px;">
			<option value="">Select to view request or approval</option>
