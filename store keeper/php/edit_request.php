...
<body>
	...
	if(isset($_GET['id']) && isset($_GET['name'])){
		...
		<div class="row col col-md-12">
			<div>
				<label for="editable_name" class="form-label">Drug Name: </label>
				<input type="text" value="<?php echo $name; ?>" id='editable_name' class="form-control" disabled>
			</div>
			<div class="mb-3">
				<label for="editable_av_qty" class="form-label">Available Quantity: </label>
				<input type="text" value="<?php echo $quantity." ".$measure; ?>" id="editable_av_qty" class="form-control" disabled>
			</div>
			<div class="mb-3">
				<label for="editable_req_qty" class="form-label">Requested Quantity: </label>
				<input type="number" value="<?php echo $required; ?>" id="editable_req_qty" onkeyup="validateQuantity(this.value,'editable_req_qty_error');"
						onblur="validateQuantity(this.value,'editable_req_qty_error');" min='1' class="form-control">
				<code id="editable_req_qty_error"  style="display: none;"></code>		
			</div>
			<div class="mb-3">
				<label for="" class="form-label">Expire Date: </label>
				<input type="text" value="<?php echo $expire_date; ?>" id="editable_expire_date" class="form-control" disabled>
			</div>
			<div class="mb-3">
