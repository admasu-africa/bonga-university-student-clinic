	...
	<?php include 'include/side_bar.html'; ?>
     ...
     <div class="home">
      ...
      <div class="row content"> 
        <!--  -->
	      <div class="col col-12 col-md-12">      <div class="inside_text_n">
	         <?php 
		include 'include/dbc.inc.php';
		$sql = "select * from news where view = 'all' or view = 'student' order by posted_date desc";
